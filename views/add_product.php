          ...
          <fieldset dir="rtl">
              ...
              <div class="articleform">
               <form action="../controllers/addproductcon.php" name="frmarticlenew" method="POST" enctype="multipart/form-data">
                ...
                <textarea name="txtarticle" placeholder="با ادیتور حرفه ای ما شروع به نوشتن کن..." id="txtarticle" cols="43" rows="10" tabindex="7" required></textarea>
                <br />
                ...
                <input type="file" name="fileupload" id="fileupload" accept=".jpg, .jpeg, .png" required/>
