    ...
    <div class="signupcard">
       ...
       <div class="mainform" dir="rtl">
           <form action="../controllers/register_controller.php" name="frmregister" method="POST">
               ...
               <input type="text" style="font-family: Vazir;" name="txtname" id="txtname" placeholder="مثال : احسان" required/>
               <br />
               <label for="txtfamilyname">نام خانوادگی (فارسی) :</label>
               <input type="text" style="font-family: Vazir;" name="txtfamilyname" id="txtfamilyname" placeholder="مثال : جوادی" required/>
               <br />
               <label for="txtusername">نام کاربری :</label>
               <input type="text" style="font-family: Vazir;" name="txtusername" id="txtusername" maxlength="10" placeholder="مثال : mmdreza" required/>
               <br />
               ...
               <input type="password" style="font-family: Vazir;" name="txtpassword" id="txtpassword" maxlength="8" placeholder="رمز ورود به حساب کاربری" required/>
