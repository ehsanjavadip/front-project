...
<body text="black" link="red" alink="green" vlink="gray" onload="">
    <div class="website">
        ...
        <div class="whereami" style="background-color: #f5f5f5; font-size: 17px; padding-top: 10px; padding-bottom:10px;">
          <div>
            <span>شما اینجا هستید : </span><span>خانه</span>  <i class="fa fa-arrow-left"></i>  <span>مدیریت</span>   <i class="fa fa-arrow-left"></i>  <span>کاربران</span>  <i class="fa fa-arrow-left"></i>  <span>ویرایش حساب کاربری</span>  
          </div>
        </div>
